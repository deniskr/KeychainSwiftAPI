#
#  Be sure to run `pod spec lint KeychainSwiftAPI.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "Keychain API in Swift"
  ...
  s.source       = { :git => "https://github.com/deniskr/KeychainSwiftAPI.git", :tag => "0.0.1" }
  ...
  s.source_files  = "KeychainSwiftAPI/*.{h,m,swift}"
